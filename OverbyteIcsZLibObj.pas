...
procedure free(Block: Pointer); cdecl;{$IFDEF FPC} public;{$ENDIF}
begin
  FreeMem(Block);
end;
...
Function memcpy(dest, source: Pointer; count: size_t): Pointer; cdecl;{$IFDEF FPC} public;{$ENDIF}
//procedure memcpy(dest, source: Pointer; count: size_t);
begin
