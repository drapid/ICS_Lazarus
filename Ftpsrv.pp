...
uses
    Windows, SysUtils, Classes, Winsock, WSocket, FtpSrvC, FtpSrvT;
...
{$ENDIF}
    ...
    protected
        ...
        procedure FTPSrvDeallocateHWnd(WHandle : HWND);
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
procedure TFtpServer.FTPSrvDeallocateHWnd(WHandle : HWND);
begin
{$IFDEF NOFORMS}
