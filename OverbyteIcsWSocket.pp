...
{$ENDIF}
  ...
  protected
    ...
    function    GetRcvdCount: u_long;virtual;//steven fixed LongInt; virtual;
...
{$ENDIF}
  ...
  protected
    ...
    property RcvdCount : u_long {steven fixed LongInt}  read  GetRcvdCount;
...
{$ENDIF}
  ...
  protected
      ...
      function    GetRcvdCount : u_long { steven fixed LongInt}; override;
...
procedure InitializeAddr(var AAddr: TSockAddrIn; AIPVersion: TSocketFamily);
    {$IFDEF USE_INLINE} inline; {$ENDIF}
begin
...
function SizeOfAddr(const AAddr: TSockAddrIn): Integer;
    {$IFDEF USE_INLINE} inline; {$ENDIF}
begin
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TCustomSocksWSocket.GetRcvdCount : u_long;// LongInt;
begin
    if FSocksRcvdCnt <= 0 then
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TCustomLineWSocket.GetRcvdCount : u_long;//LongInt;
begin
