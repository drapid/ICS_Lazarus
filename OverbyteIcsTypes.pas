...
Oct 11, 2024 V9.4  Changed u_long to LongWord from Longint since this is what Windows
...
const
  OverbyteIcsTypesVersion = 903;
  CopyRight : String      = ' OverbyteIcsTypes (c) 2004-2024 F. Piette V9.3 ';
...
{$ENDIF}
  ...
  addrinfo = packed record
    ...
    ai_addrlen      : size_t; // u_int;        // Length of ai_addr
